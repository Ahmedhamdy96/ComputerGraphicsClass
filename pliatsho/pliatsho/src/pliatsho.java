...
public class pliatsho extends Applet
{
	...
	public void paint(Graphics g)
	{
		...
		int[]xp_body={70+x,70+x,50+x,50+x,110+x,110+x,90+x,90+x}; // body
		int[]yp_body={80,100,115,190,190,115,100,80};
		g.fillPolygon(xp_body,yp_body,8);

		g.setColor(Color.green); // arm
