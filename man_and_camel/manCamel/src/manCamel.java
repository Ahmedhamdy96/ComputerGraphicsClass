 ...
 * @(#)manCamel.java
 *
 * manCamel Applet application
 * Man and Camel Example [ 3.38 ] Page [ 6.128 ]
 * @author
...
public class manCamel extends Applet {
	...
	public void paint(Graphics g)
	{
		...
		g.fillArc(190+x,50,40,20,270,180); // mouth of camel

		g.setColor(Color.black);
		g.fillOval(200+x,50,10,10);  // camel's eye

		g.setColor(Color.yellow);    //camel's tail
		g.drawLine(x,120,x,150);
		g.setColor(Color.black);
		g.fillOval(260+x,60,30,30);  // man's head

		g.setColor(Color.green);
		int[]xp_man={270+x,280+x,280+x,290+x,300+x,250+x,260+x,270+x}; // man's body
		int[]yp_man={90,90,100,110,240,240,110,100};
		g.fillPolygon(xp_man,yp_man,8);

		g.setColor(Color.black);
		int[]xp_man_arm={270+x,280+x,280+x,300+x,300+x,280+x,270+x};   // man's arm
		int[]yp_man_arm={110,110,130,110,120,150,140};
		g.fillPolygon(xp_man_arm,yp_man_arm,7);
		g.fillOval(300+x,110,10,10);

		g.setColor(Color.black);
		int[]xp_first_leg={280+x,290+x,290+x+j,300+x+j,300+x+j,280+x+j};// man's left leg
		int[]yp_first_leg={240,240,250,250,260,260};
		g.fillPolygon(xp_first_leg,yp_first_leg,6);

		int[]xp_second_leg={260+x,270+x,270+x-j,280+x-j,280+x-j,260+x-j};// man's right leg
